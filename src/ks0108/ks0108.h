...
// Ports
#define LCD_CMD_PORT		PIOA // Command Output Register
#define LCD_RES_PORT		PIOA

#define LCD_DATA_IN			PIOA		// Data Input Register
#define LCD_DATA_OUT		PIOA // Data Output Register
...
extern void _delay_ms(uint32_t us);
