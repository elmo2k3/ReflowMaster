...
//    Page Name | Number | Periodic | Drehgeber | Button | Init page
    {"Reflow Master", 0, update_singletone, singletone_drehgeber, singletone_button_pressed, page_singletone},
    {"Reflow Master2", 0, update_singletone, singletone_drehgeber, singletone_button_pressed, page_singletone}
};
